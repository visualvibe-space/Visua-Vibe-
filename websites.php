...
.technology-section::before {
    ...
    width: 100%;
    height: 100%;
    background: radial-gradient(circle at 80% 20%, rgba(247, 37, 133, 0.1), transparent 70%);
    z-index: 0;
}
...
<body>
    ...
    <header id="home">
        ...
        <div class="hero-content">
            ...
            <h1 class="hero-title">Website Development</h1>
            <p class="hero-subtitle">Crafting stunning, responsive websites that deliver exceptional user experiences and drive business growth.</p>
        ...
        <section id="technology" class="technology-section">
            <div class="container">
                ...
                <p class="section-subtitle">We leverage cutting-edge technologies and modern frameworks to build robust, scalable, and high-performing websites.</p>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="tech-card">
                            ...
                            <p>Creating responsive and interactive user interfaces with modern technologies:</p>
                            <ul class="tech-list">
                                <li>HTML5 & CSS3</li>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="tech-card">
                            ...
                            <p>Building powerful server-side applications and APIs:</p>
                            <ul class="tech-list">
                                <li>Node.js</li>
                                <li>PHP</li>
                                <li>Python</li>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="tech-card">
                            ...
                            <p>Utilizing industry-standard tools for development and deployment:</p>
                            <ul class="tech-list">
                                <li>Git & GitHub</li>
                                <li>Netlify</li>
                                <li>VS Code</li>
                                ...
                                <li>Domain purchasing and connecting website with domain</li>
                                <li>Web Hosting</li>
                            </ul>
                        </div>
                    </div>
...
<section id="portfolio" class="portfolio-section">
    <div class="container-fluid">
        ...
        <p class="section-subtitle">
            Explore our collection of custom-built websites that showcase our technical expertise and creative design.
        </p>
            ...
            <?php endif; ?>
                        ...
                        <div class="col-md-4 mb-4">
                            ...
                            <div class="portfolio-content">
                                ...
                                <a 
                                    href="<?= htmlspecialchars($site['website_url']) ?>" 
                                    target="_blank"
                                    class="explore-btn"
                                >
    ...
    <script>
        ...
        // Update the checkVisibility function to include tech cards
function checkVisibility() {
    const elements = document.querySelectorAll('.section-title, .section-subtitle, .portfolio-item, .tech-card');
