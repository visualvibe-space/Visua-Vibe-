...
.posters-section::before {
    ...
    width: 100%;
    height: 100%;
    background: radial-gradient(circle at 70% 30%, rgba(247, 37, 133, 0.15), transparent 70%);
    z-index: 0;
}
...
/* Responsive adjustments for posters section */
@media (max-width: 768px) {
    .poster-card {
        padding: 2rem 1.5rem;
    }
...
<body>
    ...
    <header id="home">
        ...
        <div class="hero-content">
            ...
            <h1 class="hero-title">Flyers & Posters</h1>
            <p class="hero-subtitle">Discover our collection of visually striking flyers and posters designed to capture attention and communicate your message effectively.</p>
            <a href="#portfolio" class="cta-button">View Our Work</a>
        </div>
    </header>

    <!-- Posters & Flyers Section -->
<section id="posters-flyers" class="posters-section">
    <div class="container">
        <h2 class="section-title">Posters & Flyers</h2>
        <p class="section-subtitle">Creating eye-catching posters and flyers that capture attention and effectively communicate your message.</p>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-6 col-md-6 mb-4">
                <div class="poster-card">
                    ...
                    <h3>Poster Design</h3>
                    <p>Professional poster designs for various purposes:</p>
                    <ul class="poster-list">
                        <li>Event Posters</li>
                        <li>Movie Posters</li>
                        <li>Concert Posters</li>
                        <li>Business Posters</li>
                        <li>Educational Posters</li>
                        <li>Promotional Posters</li>
                        <li>Digital Posters</li>
                        <li>Print-ready Posters</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6 mb-4">
                <div class="poster-card">
                    ...
                    <h3>Flyer Design</h3>
                    <p>Effective flyer designs for marketing and promotion:</p>
                    <ul class="poster-list">
        ...
        <div class="row justify-content-center mt-4">
            <div class="col-lg-12">
                <div class="poster-card">
                    ...
                    <p>Comprehensive design solutions for posters and flyers:</p>
                    <div class="row">
                        <div class="col-md-6">
                            <ul class="poster-list">
...
<section id="portfolio" class="portfolio-section">
    <div class="container-fluid">
        ...
        <h2 class="section-title">Our Flyers & Posters</h2>
        <p class="section-subtitle">
            Explore our collection of creative designs that showcase our visual communication skills.
        </p>
        ...
        <?php if (!empty($flyers)): ?>
            ...
            foreach ($flyers as $flyer):
                ...
                $image = !empty($flyer['thumbnail_url'])
                    ? $flyer['thumbnail_url']
                    : $flyer['image_url'];
            ...
            <?php endif; ?>
                ...
                <div class="col-md-4 mb-4">
                    ...
                    <img
                        ...
                        class="flyer-image"
                        data-full="<?= htmlspecialchars($flyer['image_url']) ?>"
                    >

                    <div class="portfolio-content">
                        <h3><?= htmlspecialchars($flyer['title']) ?></h3>
                        <p><?= htmlspecialchars($flyer['description']) ?></p>

                        <button
    type="button"
    class="explore-btn view-image-btn"
    data-image="<?= htmlspecialchars($flyer['image_url']) ?>">
...
const fullImage = document.querySelector(".fullscreen-image");
const closeBtn = document.querySelector(".close-viewer");

document.querySelectorAll(".view-image-btn, .flyer-image").forEach(el => {
...
const images = document.querySelectorAll(".flyer-image");
const viewer = document.querySelector(".fullscreen-viewer");
const fullImage = document.querySelector(".fullscreen-image");
const closeBtn = document.querySelector(".close-viewer");
...
viewer.addEventListener("click", e => {
    if (e.target === viewer) {
        ...
        // Update the checkVisibility function to include poster cards
function checkVisibility() {
    const elements = document.querySelectorAll('.section-title, .section-subtitle, .portfolio-item, .tech-card, .app-card, .merch-card, .uiux-card, .process-step, .video-card, .logo-card, .poster-card');
