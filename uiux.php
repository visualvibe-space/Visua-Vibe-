...
<section id="uiux" class="uiux-section">
    <div class="container">
        ...
        <p class="section-subtitle">Creating intuitive, beautiful, and user-centered designs that enhance user experience and drive engagement.</p>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="uiux-card">
                    ...
                    <p>Focusing on user-centered design processes:</p>
                    <ul class="uiux-list">
                        <li>User Research</li>
                        <li>Wireframing</li>
                        <li>Prototyping</li>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="uiux-card">
                    ...
                    <p>Bringing designs to life with interactive prototypes:</p>
                    <ul class="uiux-list">
        ...
        <div class="row justify-content-center mt-4">
            ...
            <div class="col-lg-6 col-md-6 mb-4">
                <div class="uiux-card">
                    ...
                    <p>Utilizing industry-standard design tools:</p>
                    <ul class="uiux-list">
                        <li>Figma</li>
                        <li>Adobe XD</li>
                        <li>Sketch</li>
            ...
            <div class="col-lg-6 col-md-6 mb-4">
                <div class="uiux-card">
                    ...
                    <p>Comprehensive design documentation and assets:</p>
                    <ul class="uiux-list">
                        <li>Style Guides</li>
...
<section id="portfolio" class="portfolio-section">
    <div class="container-fluid">
        ...
        <h2 class="section-title">Our UI / UX Designs</h2>
        <p class="section-subtitle">
            Explore our modern UI/UX prototypes crafted for seamless user experiences and clean visual design.
        </p>

        <?php if (!empty($uiuxDesigns)): ?>

            <?php
            $count = 0;
            foreach ($uiuxDesigns as $design):

                // thumbnail fallback
                $image = !empty($design['thumbnail_url'])
                        ...
                        <div class="col-md-4 mb-4">
                            ...
                            <div class="portfolio-content">
                                ...
                                <?php if (!empty($design['prototype_url'])): ?>
                                    <a
                                        href="<?= htmlspecialchars($design['prototype_url']) ?>"
                                        target="_blank"
                                        class="explore-btn"
                                    >
